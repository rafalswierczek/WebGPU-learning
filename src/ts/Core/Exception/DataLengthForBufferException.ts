export class DataLengthForBufferException extends Error
{
	...
	{
		super(`Size of new data for buffer cannot be bigger than buffer size. Buffer: ${buffer.label}, Buffer size: ${buffer.size}, New data size: ${dataForBuffer.byteLength}`);
